...
class OutletAccessory extends Base_accessory_1.default {
    ...
    _registerCharacteristics(dps) {
        ...
        if (energyKeys.volts) {
            ...
            this._removeCharacteristic(service, EnergyCharacteristics.Volts);
        ...
        if (energyKeys.amps) {
            ...
            this._removeCharacteristic(service, EnergyCharacteristics.Amperes);
        ...
        if (energyKeys.watts) {
            ...
            this._removeCharacteristic(service, EnergyCharacteristics.Watts);
