...
const STATE_OTHER = 9;
class AirPurifierAccessory extends Base_accessory_1.default {
    ...
    constructor(...props) {
        ...
        if (this.device.context.noRotationSpeed) {
            let fanSpeedSteps = this.device.context.fanSpeedSteps &&
    ...
    convertRotationSpeedFromTuyaToHomeKit(value) {
        ...
        const speed = this.device.context.fanSpeedSteps
            ? '' + this.getKeyByValue(this._rotationStops, value)
            : this.getKeyByValue(this._rotationStops, value);
        if (speed === undefined) {
            return 0;
        }
...
//# sourceMappingURL=AirPurifier.accessory.js.map