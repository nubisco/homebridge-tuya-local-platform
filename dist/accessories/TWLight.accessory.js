...
class TWLightAccessory extends Base_accessory_1.default {
    ...
    _registerCharacteristics(dps) {
        ...
        this.device.on('change', (changes, state) => {
            ...
            if (changes.hasOwnProperty(this.dpBrightness) &&
                this.convertBrightnessFromHomeKitToTuya(characteristicBrightness.value) !== changes[this.dpBrightness])
            ...
            if (changes.hasOwnProperty(this.dpColorTemperature)) {
                if (this.convertColorTemperatureFromHomeKitToTuya(characteristicColorTemperature.value) !==
...
exports.default = TWLightAccessory;
//# sourceMappingURL=TWLight.accessory.js.map