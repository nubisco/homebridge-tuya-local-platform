...
class CustomMultiOutletAccessory extends Base_accessory_1.default {
    ...
    _verifyCachedPlatformAccessory() {
        ...
        this.device.context.outlets.forEach((outlet, _i) => {
            ...
            if (service)
                this._checkServiceName(service, name);
            else
                service = this.accessory.addService(Service.Outlet, name, 'outlet ' + outlet.dp);
...
exports.default = CustomMultiOutletAccessory;
//# sourceMappingURL=CustomMultiOutlet.accessory.js.map