...
class SimpleBlindsAccessory extends Base_accessory_1.default {
            ...
            if (changes.hasOwnProperty(this.dpAction)) {
                switch (changes[this.dpAction]) {
                    ...
                    case this.cmdStop: {
                        if (this.changeTimeout)
                            clearTimeout(this.changeTimeout);
                        this.log.debug('[TuyaAccessory] Blinds last change was ' +
                            this.changeTime +
                            '; ' +
                            (Date.now() - this.changeTime) +
                            'ms ago');
                        if (this.changeTime) {
                        ...
                        characteristicPositionState.updateValue(Characteristic.PositionState.STOPPED);
                        this.log.debug('[TuyaAccessory] Blinds marked stopped at ' +
                            adjustedPosition +
                            '; assumed to be at ' +
    ...
    setTargetPosition(value, callback) {
        ...
        if (this.changeTime !== false) {
            this.log.debug('[TuyaAccessory] Blinds ' +
        ...
        if (numValue !== BLINDS_OPEN && numValue !== BLINDS_CLOSED) {
            ...
            this.log.debug('[TuyaAccessory] Blinds assumed started ' +
                this.changeTime +
                '; ' +
                (Date.now() - this.changeTime) +
                'ms ago');
...
exports.default = SimpleBlindsAccessory;
//# sourceMappingURL=SimpleBlinds.accessory.js.map