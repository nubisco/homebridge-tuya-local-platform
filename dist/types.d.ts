import type { API, Categories, Characteristic, CharacteristicValue, Logger, PlatformAccessory, Service, WithUUID } from 'homebridge';
...
export declare enum TuyaProtocolVersion {
    V3_1 = "3.1",
    V3_3 = "3.3",
    V3_4 = "3.4"
}
export declare enum TuyaCommand {
    CONTROL = 7,
    STATUS = 8,
    HEART_BEAT = 9,
    DP_QUERY = 10,
